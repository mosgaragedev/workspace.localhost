...
import { Suspense, createContext, lazy, use, useEffect, useEffectEvent, useMemo, useState, useSyncExternalStore } from "react";
...
function MetaOrControl() {
	return useSyncExternalStore(noop, () => true, () => false) && /Windows|Linux/i.test(navigator.userAgent) ? "Ctrl" : "⌘";
}
