...
function warnIfToJSONStringProvided(codec) {
  if (hasWarnedAboutToJSONString || !codec.toJSONString) return;
  hasWarnedAboutToJSONString = true;
  console.warn('`toJSONString` is deprecated and no longer needed, please remove it.');
}
...
function assertStringMessage(message) {
