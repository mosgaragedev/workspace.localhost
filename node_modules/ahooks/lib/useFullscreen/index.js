...
var useFullscreen = function useFullscreen(target, options) {
  var _ref = options || {},
    ...
    _ref$pageFullscreen = _ref.pageFullscreen,
    pageFullscreen = _ref$pageFullscreen === void 0 ? false : _ref$pageFullscreen;
  var _ref2 = (0, _utils.isBoolean)(pageFullscreen) || !pageFullscreen ? {} : pageFullscreen,
    _ref2$className = _ref2.className,
    className = _ref2$className === void 0 ? 'ahooks-page-fullscreen' : _ref2$className,
    _ref2$zIndex = _ref2.zIndex,
    zIndex = _ref2$zIndex === void 0 ? 999999 : _ref2$zIndex;
  ...
  var _useState = (0, _react.useState)(getIsFullscreen),
