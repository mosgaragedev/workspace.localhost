...
var useAntdTable = function useAntdTable(service) {
  ...
  var result = (0, _usePagination["default"])(service, Object.assign(Object.assign({
    ready: ready,
    manual: true
  }, rest), {
    onSuccess: function onSuccess() {
      ...
      (_a = rest.onSuccess) === null || _a === void 0 ? void 0 : (_a2 = _a).call.apply(_a2, [rest].concat(args));
    }
  }));
  ...
  var reset = function reset() {
    ...
    _submit(Object.assign(Object.assign({}, (defaultParams === null || defaultParams === void 0 ? void 0 : defaultParams[0]) || {}), {
  ...
  var submit = function submit(e) {
    ...
    _submit(runSuccessRef.current ? undefined : Object.assign({
