...
class BuildHelper {
    ...
    initialized = false;
    constructor() {
        const extName = utils.getAzdataApi() ? "Microsoft.sql-database-projects" /* sqldbproj.extension.name */ : "ms-mssql.sql-database-projects-vscode" /* sqldbproj.extension.vsCodeName */;
    ...
    constructBuildArguments(buildDirPath, sqlProjStyle) {
        ...
        const isSdkStyle = utils.getAzdataApi()
            ? sqlProjStyle === 0 /* mssql.ProjectType.SdkStyle */
            : sqlProjStyle === 0 /* vscodeMssql.ProjectType.SdkStyle */;
        if (!isSdkStyle) {
