...
![samples](https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/main.png)
...
![samples](https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/samplesCommand.gif)
...
![docs](https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/howDocsWork.gif)

It is also possible to use the command `PnP PS: Open docs for command` to open the docs for a specific command.

![docs](https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/docsCommand.gif)

### 3️⃣ Command list tree view

![docs](https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/treeViewIcon.png)

The command list also has the functionality to group commands view by command name verb

![docs](https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/treeView.png)
...
![snippetsList](https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/snippets.gif)
...
![snippetsList](https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/snippetsList.png)

It is also possible to use the command `Insert Snippet` in VS Code to see the full list

![snippetsList](https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/listOfCommandsFromToolbar.png)
...
![docs](https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/webPageButtons.png)
...
![commands](https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/commands.png)
...
<h1 align="center">
  <img alt="Microsoft 365 & Power Platform Community" src="https://github.com/pnp/vscode-pnp-powershell/raw/HEAD/assets/images/parker-pnp.png" width="200px" />
</h1>
