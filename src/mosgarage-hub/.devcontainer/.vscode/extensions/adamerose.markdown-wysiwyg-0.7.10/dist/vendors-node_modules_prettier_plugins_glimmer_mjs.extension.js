"use strict";
exports.id = "vendors-node_modules_prettier_plugins_glimmer_mjs";
exports.ids = ["vendors-node_modules_prettier_plugins_glimmer_mjs"];
exports.modules = {
...
/* harmony export */   "default": () => (/* binding */ bl),
/* harmony export */   "languages": () => (/* binding */ Sn),
/* harmony export */   "parsers": () => (/* binding */ Ir),
/* harmony export */   "printers": () => (/* binding */ pa)
/* harmony export */ });
...
`,o);if(c===-1&&(c=this.source.length),a===r-1){if(o+n>c)return c;if(false){}return o+n}else{if(c===-1)return 0;a+=1,o=c+1}}return i}};function S(t,e){let{module:r,loc:n}=e,{line:s,column:i}=n.start,a=e.asString(),o=a?`
...
;
//# sourceMappingURL=vendors-node_modules_prettier_plugins_glimmer_mjs.extension.js.map