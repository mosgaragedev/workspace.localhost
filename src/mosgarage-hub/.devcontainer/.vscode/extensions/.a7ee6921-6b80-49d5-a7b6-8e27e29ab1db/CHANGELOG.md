...
- fixed issue with `Edit Definition` for items with special characters in the name ([#43](https://github.com/gbrueckl/FabricStudio/blob/HEAD/issues/43))
...
**v2.9.5**:
- improved logging when creating new treeview-items ([#33](https://github.com/gbrueckl/FabricStudio/blob/HEAD/issues/33))

**v2.9.4**:
- fixed issue with special characters in workspace and/or item names ([#33](https://github.com/gbrueckl/FabricStudio/blob/HEAD/issues/33))

**v2.9.3**:
- fixed issue with load of workspace children

**v2.9.2**:
- improved logging when encountering errors while loading the treeviews ([#33](https://github.com/gbrueckl/FabricStudio/blob/HEAD/issues/33))
...
- fixed issue with special characters (`%20`, etc.) being encoded in item names after publishing from Fabric Studio ([#20](https://github.com/gbrueckl/FabricStudio/blob/HEAD/issues/20))
...
- added new `-H` flag to be used with API calls to also show the response header of the initial request ([#14](https://github.com/gbrueckl/FabricStudio/blob/HEAD/issues/14))
...
**v1.14.5**:
- fixed issue when deleting a folder in the workspace browser ([#13](https://github.com/gbrueckl/FabricStudio/blob/HEAD/issues/13))
...
**v1.10.2**:
- fixed issue with definitions in tree-views ([#11](https://github.com/gbrueckl/FabricStudio/blob/HEAD/issues/11))
...
- fixed issue with [`$(_cells)`](https://github.com/gbrueckl/FabricStudio/blob/HEAD/README.md#notebooks) notebook variable
...
**v0.9.4**:
- added [Fabric Notebooks](https://github.com/gbrueckl/FabricStudio/blob/HEAD/README.md#notebooks) to run arbitrary REST API calls against Fabric
- added [GIT integration](https://github.com/gbrueckl/FabricStudio/blob/HEAD/README.md#fabric-git-integration) to manage Fabric source control from within VSCode
