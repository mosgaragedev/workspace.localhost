...
![Create new OpenAPI file from a template](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/New%20OpenAPI%20file.gif?raw=true)
...
![Navigation inside the OpenAPI file](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/Navigation.gif?raw=true)
...
![Add new API path and verb](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/Add%20paths%20and%20verbs.gif?raw=true)
...
![Go to definition](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/Go%20to%20Definition.gif?raw=true)
...
![](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/OutlineSettings.png)
...
![OpenAPI Preview Pane](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/OASPreview.png)
...
![OpenAPI Preview Pane](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/Change_OpenAPI_Preview_engine.png)
...
3. Locate the **Openapi: Approved Hostnames** setting, click on **Add item**, and write the hostname you need for resolving external references.
   ![Configure approved hosts and authentication](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/Configure%20approved%20hosts.png)
...
![Configure approved hosts and authentication](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/Configure%20approved%20hosts%20authentication.png)
...
> ![42Crunch: Open Settings](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/42Crunch%20Open%20Settings.png)
...
![IDE-PlatformIntegration](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/IDE-PlatformIntegration.png)
...
![](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/StartAudit.png)
...
![AuditIssuesList](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/AuditIssuesList.png)
...
![AuditIssuesList-Full](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/AuditIssuesList-Full.png)
...
- For each operation in the OpenAPI file, a request is created. You can test individual requests using the **Try** button top-right.
  ...
  ![](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/ScantryIt.png)
...
- Requests can be arranged into testing scenarios: a scenario combines one or multiple requests, for example you need to create a resource before you can view it. The editor allows you to extract data as variables from a request execution to inject it into the next step.
  ...
  ![](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/ScanScenarios.png)
...
![](https://github.com/42Crunch/vscode-openapi/raw/HEAD/images/ScanReport.gif)
