...
| ![logo](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/logo-bl.png) | If you have kids, hug and squeeze them **every** single chance you get... I lost my daughter ~2 years ago, I loved her with every ounce of my soul, now every day is filled with overwhelming sadness, I am... 4everbroken. We were working on this together when she left me, please consider purchasing a (cheap++) license when the licensing scheme goes into effect. | ![cmdline-banner](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/cmdline-banner.png) |
| ---------- | ------------------------------- | -------------------------------------------------------- |
...
![src0_1](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/npm.png) ![src0_2](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/node.png) ![src11](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/python.png) ![src4](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/workspace.png) ![src6](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/ts.png) ![src1](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/ant.png) ![src0y](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/yarn.png) ![src14e](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/eslint.png) ![src2](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/grunt.png) ![src3](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/gulp.png) ![src8](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/ruby.png) ![src9](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/powershell.png) ![src13](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/gradle.png) ![src5_1](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/cmake.png) ![src5_2](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/make.png) ![src7](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/bat.png) ![src10](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/bash.png) ![src12](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/nsis.png) ![src14](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/webpack.png) ![src13](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/img/sources/maven.png)
...
| ----------------------------------------- | ----------------------------------------- | ----------------------------------------- |
| ![ss0](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/treeview1.png) | ![ss1](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/taskview2.png) | ![ss2](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/taskview3.png) |

| Grunt/Gulp in Subfolders (v1.14)          | Npm Commands (v1.16)                      | Task Groupings (v1.23)                    |
| ----------------------------------------- | ----------------------------------------- | ----------------------------------------- |
| ![ss4](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/taskview4.png) | ![ss5](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/taskview5.png) | ![ss6](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/taskview6.png) |

| Multi-Level Task Groupings (v1.29)        | Run with Args, No Terminal (1.30)         | Last Tasks (1.25) Favorites (2.0)         |
| ----------------------------------------- | ----------------------------------------- | ----------------------------------------- |
| ![ss7](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/taskview7.png) | ![ss8](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/taskview8.png) | ![ss9](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/taskview9.png) |
...
![task-monitor-img1](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/taskmonitor1.png) ![task-monitor-img2](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/taskmonitor2.png)
...
![parsing-report-img](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/parsingreport.png) ![task-details-img](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/taskdetails1.png)
...
![app-publisher-cmdline-banner](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/cmdline-banner-ap.png) ![spmh-cmdline-banner2](https://github.com/spmeesseman/vscode-taskexplorer/raw/HEAD/res/readme/cmdline-banner.png)
