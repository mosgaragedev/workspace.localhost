...
class ManifestProcessor extends BaseProcessor {
    constructor(manifest, options = {}) {
        ...
        this.vsix = Object.assign(Object.assign({}, this.vsix), { id: manifest.name, displayName: manifest.displayName || manifest.name, version: manifest.version, publisher: manifest.publisher, target, engine: manifest.engines['vscode'], description: manifest.description || '', categories: (manifest.categories || []).join(','), flags: flags.join(' '), links: {
                repository,
