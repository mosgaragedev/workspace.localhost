...
![Project Initializer palette entry.](https://github.com/redhat-developer/vscode-project-initializer/raw/HEAD/images/fabric8LauncherPaletteEntry.png "Project Initializer Palette entry")
...
The Project Initializer by Red Hat for Visual Studio Code collects anonymous [usage data](https://github.com/redhat-developer/vscode-project-initializer/blob/HEAD/USAGE_DATA.md) and sends it to Red Hat servers to help improve our products and services. Read our [privacy statement](https://developers.redhat.com/article/tool-data-collection) to learn more. This extension respects the `redhat.telemetry.enabled` setting which you can learn more about at https://github.com/redhat-developer/vscode-redhat-telemetry#how-to-disable-telemetry-reporting
