...
![Alt text](https://github.com/bobmagicii/vscode-dashboard/raw/HEAD/local/gfx/ex-dashboard.png "A Busy Dashboard")
...
![Alt text](https://github.com/bobmagicii/vscode-dashboard/raw/HEAD/local/gfx/ex-autotheme.png "Dark and Light")
...
![Alt text](https://github.com/bobmagicii/vscode-dashboard/raw/HEAD/local/gfx/ex-responsive.png "Responsive AF")
...
![Alt text](https://github.com/bobmagicii/vscode-dashboard/raw/HEAD/local/gfx/ex-first-open.png "First Open")
...
![Alt text](https://github.com/bobmagicii/vscode-dashboard/raw/HEAD/local/gfx/ex-dashboard-settings.png "Dashboard Settings")

![Alt text](https://github.com/bobmagicii/vscode-dashboard/raw/HEAD/local/gfx/ex-project-settings.png "Project Settings")

![Alt text](https://github.com/bobmagicii/vscode-dashboard/raw/HEAD/local/gfx/ex-folder-menu.png "Folder Menu")
...
![Alt text](https://github.com/bobmagicii/vscode-dashboard/raw/HEAD/local/gfx/ex-setting-sync.png "Don't sync that setting.")
